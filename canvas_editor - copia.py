...
# -*- coding: utf-8 -*-
"""
🎨 Canvas Editor v3.0 - Sistema de Handles Profesional
...
class CanvasEditor(QMainWindow):
    ...
    def __init__(self):
        ...
        self.statusBar().showMessage(
            "✨ Canvas Editor v3.0 - Handles Profesionales | "
            "🔵 Esquinas: proporción | 🔵 Lados: libre | "
            "🟢 Verde: rotar | Shift: snap 15° | Alt: deformar",
            10000
        )
    ...
    def create_left_panel(self):
        ...
        info = QLabel(
            "💡 <b>Cómo usar los handles:</b><br><br>"
            "🔵 <b>Esquinas azules:</b><br>"
            "   • Arrastra → mantiene proporción<br>"
            "   • Alt + arrastrar → deforma libre<br><br>"
            "🔵 <b>Lados azules:</b><br>"
            "   • Arrastra → estira en esa dirección<br><br>"
            "🟢 <b>Handle verde (arriba):</b><br>"
            "   • Arrastra → rota la imagen<br>"
            "   • Shift + arrastrar → snap 15°"
        )
    ...
    def create_toolbar(self):
        ...
        # Título
        title = QLabel("🎨 Canvas Editor v3.0")
    ...
    def update_layers_list(self):
        ...
        for item in items:
            ...
            list_item = QListWidgetItem(f"🖼️ {name}")
    ...
    def show_about(self):
        QMessageBox.about(
            ...
            <ul>
                <li>🔵 8 handles azules de redimensión</li>
                <li>🟢 Handle verde de rotación</li>
                <li>📐 Tooltips con dimensiones/ángulo</li>
                <li>⌨️ Modificadores: Shift (snap) y Alt (deformar)</li>
                <li>🎯 Cursores apropiados</li>
                <li>📋 Panel de capas en tiempo real</li>
            </ul>
            
            <h3>🎯 Uso:</h3>
            <p><b>Esquinas azules:</b> mantienen proporción por defecto</p>
            <p><b>Alt + esquina:</b> deformar libremente</p>
            <p><b>Lados azules:</b> estiran en esa dirección</p>
